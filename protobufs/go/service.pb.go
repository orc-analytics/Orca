...
func (x *DagState) GetStatus() bool {
	if x != nil {
		return x.Status
	}
	return false
...
var file_service_proto_rawDesc = string([]byte{
	...
	0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x49, 0x64, 0x22, 0x22, 0x0a, 0x08, 0x44, 0x61, 0x67, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x7a, 0x0a, 0x10,
	...
	0x32, 0x07, 0x2e, 0x57, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x42, 0x06, 0xba, 0x48, 0x03, 0xc8, 0x01,
	0x01, 0x52, 0x06, 0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x12, 0x3d, 0x0a, 0x11, 0x61, 0x6c, 0x67,
	0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x41, 0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d,
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x10, 0x61, 0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74, 0x68,
	0x6d, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x22, 0x6c, 0x0a, 0x0f, 0x41, 0x6c, 0x67, 0x6f,
	...
	,
...
var file_service_proto_goTypes = []any{
	...
	(*ExecutionRequest)(nil),         // 16: ExecutionRequest
	...
	nil,                              // 22: ExecuteDAG.InputsEntry
	nil,                              // 23: ExecutionResult.OutputsEntry
...
var file_service_proto_depIdxs = []int32{
	...
	24, // 5: Result.struct_value:type_name -> google.protobuf.Struct
	...
	22, // 11: ExecuteDAG.inputs:type_name -> ExecuteDAG.InputsEntry
	0,  // 12: ExecutionResult.status:type_name -> ResultStatus
	23, // 13: ExecutionResult.outputs:type_name -> ExecutionResult.OutputsEntry
	3,  // 14: ExecutionRequest.window:type_name -> Window
	17, // 15: ExecutionRequest.algorithm_results:type_name -> AlgorithmResult
	...
	21, // 19: HealthCheckResponse.metrics:type_name -> ProcessorMetrics
	10, // 20: OrcaCore.RegisterProcessor:input_type -> ProcessorRegistration
	3,  // 21: OrcaCore.EmitWindow:input_type -> Window
	9,  // 22: OrcaCore.SubmitResult:input_type -> Result
	14, // 23: OrcaCore.GetDagState:input_type -> DagStateRequest
	16, // 24: OrcaProcessor.ExecuteDAG:input_type -> ExecutionRequest
	19, // 25: OrcaProcessor.HealthCheck:input_type -> HealthCheckRequest
	18, // 26: OrcaCore.RegisterProcessor:output_type -> Status
	5,  // 27: OrcaCore.EmitWindow:output_type -> WindowEmitStatus
	18, // 28: OrcaCore.SubmitResult:output_type -> Status
	15, // 29: OrcaCore.GetDagState:output_type -> DagState
	13, // 30: OrcaProcessor.ExecuteDAG:output_type -> ExecutionResult
	20, // 31: OrcaProcessor.HealthCheck:output_type -> HealthCheckResponse
