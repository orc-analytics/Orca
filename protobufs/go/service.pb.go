...
type WindowTypeRegisterStatus_StatusEnum int32

const (
	// the window was not registered
	WindowTypeRegisterStatus_WINDOW_NOT_REGISTERED WindowTypeRegisterStatus_StatusEnum = 0
	// the window was registered successfully
	WindowTypeRegisterStatus_WINDOW_REGISTERED WindowTypeRegisterStatus_StatusEnum = 1
	// the window type already exists
	WindowTypeRegisterStatus_WINDOW_TYPE_ALREADY_EXISTS WindowTypeRegisterStatus_StatusEnum = 2
)

// Enum value maps for WindowTypeRegisterStatus_StatusEnum.
var (
	WindowTypeRegisterStatus_StatusEnum_name = map[int32]string{
		0: "WINDOW_NOT_REGISTERED",
		1: "WINDOW_REGISTERED",
		2: "WINDOW_TYPE_ALREADY_EXISTS",
	}
	WindowTypeRegisterStatus_StatusEnum_value = map[string]int32{
...
func (x WindowTypeRegisterStatus_StatusEnum) Enum() *WindowTypeRegisterStatus_StatusEnum {
	p := new(WindowTypeRegisterStatus_StatusEnum)
	*p = x
	return p
}

func (x WindowTypeRegisterStatus_StatusEnum) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (WindowTypeRegisterStatus_StatusEnum) Descriptor() protoreflect.EnumDescriptor {
	return file_service_proto_enumTypes[1].Descriptor()
}

func (WindowTypeRegisterStatus_StatusEnum) Type() protoreflect.EnumType {
	return &file_service_proto_enumTypes[1]
}

func (x WindowTypeRegisterStatus_StatusEnum) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use WindowTypeRegisterStatus_StatusEnum.Descriptor instead.
func (WindowTypeRegisterStatus_StatusEnum) EnumDescriptor() ([]byte, []int) {
...
type WindowTypeRegisterStatus struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// the status of the window registration
	Status WindowTypeRegisterStatus_StatusEnum `protobuf:"varint,1,opt,name=status,proto3,enum=WindowTypeRegisterStatus_StatusEnum" json:"status,omitempty"`
...
func (x *WindowTypeRegisterStatus) Reset() {
	*x = WindowTypeRegisterStatus{}
	mi := &file_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WindowTypeRegisterStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WindowTypeRegisterStatus) ProtoMessage() {}

func (x *WindowTypeRegisterStatus) ProtoReflect() protoreflect.Message {
	mi := &file_service_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WindowTypeRegisterStatus.ProtoReflect.Descriptor instead.
func (*WindowTypeRegisterStatus) Descriptor() ([]byte, []int) {
	return file_service_proto_rawDescGZIP(), []int{2}
}

func (x *WindowTypeRegisterStatus) GetStatus() WindowTypeRegisterStatus_StatusEnum {
	if x != nil {
		return x.Status
	}
	return WindowTypeRegisterStatus_WINDOW_NOT_REGISTERED
}

func (x *WindowTypeRegisterStatus) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type ProcessorRegistration struct {
	...
	SupportedAlgorithms []*Algorithm `protobuf:"bytes,3,rep,name=supported_algorithms,json=supportedAlgorithms,proto3" json:"supported_algorithms,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
// ExecutionRequest contains all information needed for a processor to execute
...
func (x *ExecutionRequest) GetTaskId() string {
	if x != nil {
		return x.TaskId
	}
	return ""
...
func (x *ExecutionRequest) GetAlgorithm() *Algorithm {
	if x != nil {
		return x.Algorithm
	}
	return nil
...
func (x *ExecutionRequest) GetInputs() map[string][]byte {
	if x != nil {
		return x.Inputs
	}
	return nil
...
// DagState provides a complete view of a processing DAG's execution status
// for a specific window. Used for monitoring and debugging.
type DagState struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Window being processed
	// Identifies which processing context this state belongs to
	Window *Window `protobuf:"bytes,1,opt,name=window,proto3" json:"window,omitempty"`
	// Status of each algorithm in the DAG
	// Includes both completed and pending algorithms
	AlgorithmStates []*AlgorithmState `protobuf:"bytes,2,rep,name=algorithm_states,json=algorithmStates,proto3" json:"algorithm_states,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *DagState) GetWindow() *Window {
	if x != nil {
		return x.Window
	}
	return nil
...
func (x *DagState) GetAlgorithmStates() []*AlgorithmState {
	if x != nil {
		return x.AlgorithmStates
	}
	return nil
}
...
func (x *AlgorithmState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AlgorithmState) ProtoMessage() {}

func (x *AlgorithmState) ProtoReflect() protoreflect.Message {
	mi := &file_service_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AlgorithmState.ProtoReflect.Descriptor instead.
func (*AlgorithmState) Descriptor() ([]byte, []int) {
	return file_service_proto_rawDescGZIP(), []int{14}
}

func (x *AlgorithmState) GetAlgorithm() *Algorithm {
	if x != nil {
		return x.Algorithm
	}
	return nil
...
func (x *AlgorithmState) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *AlgorithmState) GetResult() *Result {
	if x != nil {
		return x.Result
	}
	return nil
...
var file_service_proto_rawDesc = string([]byte{
	...
	,
	...
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xba,
	0x48, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x2d,
	...
	,
	...
	0x6c, 0x75, 0x65, 0x73, 0x22, 0xd2, 0x02, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12,
	0x2d, 0x0a, 0x0e, 0x61, 0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d, 0x5f, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xba, 0x48, 0x03, 0xc8, 0x01, 0x01, 0x52,
	0x0d, 0x61, 0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x20,
	...
	,
	...
	,
	...
	,
	...
	0x12, 0x1f, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x07, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c,
	0x74, 0x22, 0x3e, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x72,
	0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x72,
	0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x22, 0x3a, 0x0a, 0x12, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b,
	...
	0x01, 0x01, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0xfd, 0x01,
	...
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68,
	...
	0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e,
	0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73,
	0x52, 0x07, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x22, 0x62, 0x0a, 0x06, 0x53, 0x74, 0x61,
	...
	0x53, 0x5f, 0x53, 0x45, 0x52, 0x56, 0x49, 0x4e, 0x47, 0x10, 0x01, 0x12, 0x18, 0x0a, 0x14, 0x53,
	...
	,
	...
	,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x3c, 0x0a, 0x12, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	0x72, 0x57, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x2e, 0x57, 0x69,
	0x6e, 0x64, 0x6f, 0x77, 0x54, 0x79, 0x70, 0x65, 0x1a, 0x19, 0x2e, 0x57, 0x69, 0x6e, 0x64, 0x6f,
	0x77, 0x54, 0x79, 0x70, 0x65, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x74, 0x61,
	...
	,
	...
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x72, 0x65, 0x64, 0x69, 0x78, 0x75,
	0x73, 0x2f, 0x6f, 0x72, 0x63, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x73,
...
var file_service_proto_goTypes = []any{
	...
	(WindowTypeRegisterStatus_StatusEnum)(0), // 1: WindowTypeRegisterStatus.StatusEnum
	...
	(*WindowTypeRegisterStatus)(nil),         // 6: WindowTypeRegisterStatus
	...
	(*DagStateRequest)(nil),                  // 16: DagStateRequest
	(*DagState)(nil),                         // 17: DagState
	(*AlgorithmState)(nil),                   // 18: AlgorithmState
	(*Status)(nil),                           // 19: Status
	(*HealthCheckRequest)(nil),               // 20: HealthCheckRequest
	(*HealthCheckResponse)(nil),              // 21: HealthCheckResponse
	(*ProcessorMetrics)(nil),                 // 22: ProcessorMetrics
	nil,                                      // 23: ExecutionRequest.InputsEntry
	nil,                                      // 24: ExecutionResult.OutputsEntry
	(*structpb.Struct)(nil),                  // 25: google.protobuf.Struct
}
var file_service_proto_depIdxs = []int32{
	1,  // 0: WindowTypeRegisterStatus.status:type_name -> WindowTypeRegisterStatus.StatusEnum
	2,  // 1: WindowEmitStatus.status:type_name -> WindowEmitStatus.StatusEnum
	5,  // 2: Algorithm.window_type:type_name -> WindowType
	8,  // 3: Algorithm.dependencies:type_name -> AlgorithmDependency
	0,  // 4: Result.status:type_name -> ResultStatus
	10, // 5: Result.float_values:type_name -> FloatArray
	25, // 6: Result.struct_value:type_name -> google.protobuf.Struct
	9,  // 7: ProcessorRegistration.supported_algorithms:type_name -> Algorithm
	9,  // 8: ProcessingTask.algorithm:type_name -> Algorithm
	4,  // 9: ProcessingTask.window:type_name -> Window
	11, // 10: ProcessingTask.dependency_results:type_name -> Result
	9,  // 11: ExecutionRequest.algorithm:type_name -> Algorithm
	23, // 12: ExecutionRequest.inputs:type_name -> ExecutionRequest.InputsEntry
	0,  // 13: ExecutionResult.status:type_name -> ResultStatus
	24, // 14: ExecutionResult.outputs:type_name -> ExecutionResult.OutputsEntry
	4,  // 15: DagState.window:type_name -> Window
	18, // 16: DagState.algorithm_states:type_name -> AlgorithmState
	9,  // 17: AlgorithmState.algorithm:type_name -> Algorithm
	11, // 18: AlgorithmState.result:type_name -> Result
	3,  // 19: HealthCheckResponse.status:type_name -> HealthCheckResponse.Status
	22, // 20: HealthCheckResponse.metrics:type_name -> ProcessorMetrics
	12, // 21: OrcaCore.RegisterProcessor:input_type -> ProcessorRegistration
	5,  // 22: OrcaCore.RegisterWindowType:input_type -> WindowType
	4,  // 23: OrcaCore.EmitWindow:input_type -> Window
	9,  // 24: OrcaCore.RegisterAlgorithm:input_type -> Algorithm
	11, // 25: OrcaCore.SubmitResult:input_type -> Result
	16, // 26: OrcaCore.GetDagState:input_type -> DagStateRequest
	14, // 27: OrcaProcessor.ExecuteAlgorithm:input_type -> ExecutionRequest
	20, // 28: OrcaProcessor.HealthCheck:input_type -> HealthCheckRequest
	19, // 29: OrcaCore.RegisterProcessor:output_type -> Status
	6,  // 30: OrcaCore.RegisterWindowType:output_type -> WindowTypeRegisterStatus
	7,  // 31: OrcaCore.EmitWindow:output_type -> WindowEmitStatus
	19, // 32: OrcaCore.RegisterAlgorithm:output_type -> Status
	19, // 33: OrcaCore.SubmitResult:output_type -> Status
	17, // 34: OrcaCore.GetDagState:output_type -> DagState
	15, // 35: OrcaProcessor.ExecuteAlgorithm:output_type -> ExecutionResult
	21, // 36: OrcaProcessor.HealthCheck:output_type -> HealthCheckResponse
