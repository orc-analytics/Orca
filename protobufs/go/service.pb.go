...
func (x *ExecutionResult) GetOutputs() map[string]*structpb.Value {
	if x != nil {
		return x.Outputs
	}
	return nil
...
var file_service_proto_rawDesc = string([]byte{
	...
	0xf6, 0x01, 0x0a, 0x0f, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73,
	...
	0x70, 0x75, 0x74, 0x73, 0x1a, 0x52, 0x0a, 0x0c, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x45,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa6, 0x01, 0x0a, 0x10, 0x45, 0x78, 0x65,
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x27, 0x0a,
	0x06, 0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x07, 0x2e,
	...
	0x74, 0x68, 0x6d, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	...
	0x68, 0x6d, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x41, 0x6c, 0x67, 0x6f,
	...
	0x32, 0x6a, 0x0a, 0x08, 0x4f, 0x72, 0x63, 0x61, 0x43, 0x6f, 0x72, 0x65, 0x12, 0x34, 0x0a, 0x11,
	...
	0x6f, 0x77, 0x45, 0x6d, 0x69, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0x82, 0x01, 0x0a,
...
var file_service_proto_goTypes = []any{
	...
	nil,                              // 20: ExecuteDAG.InputsEntry
	nil,                              // 21: ExecutionResult.OutputsEntry
...
var file_service_proto_depIdxs = []int32{
	...
	22, // 5: Result.struct_value:type_name -> google.protobuf.Struct
	...
	20, // 11: ExecuteDAG.inputs:type_name -> ExecuteDAG.InputsEntry
	0,  // 12: ExecutionResult.status:type_name -> ResultStatus
	21, // 13: ExecutionResult.outputs:type_name -> ExecutionResult.OutputsEntry
	3,  // 14: ExecutionRequest.window:type_name -> Window
	15, // 15: ExecutionRequest.algorithm_results:type_name -> AlgorithmResult
	7,  // 16: ExecutionRequest.algorithms:type_name -> Algorithm
	7,  // 17: AlgorithmResult.algorithm:type_name -> Algorithm
	9,  // 18: AlgorithmResult.result:type_name -> Result
	2,  // 19: HealthCheckResponse.status:type_name -> HealthCheckResponse.Status
	19, // 20: HealthCheckResponse.metrics:type_name -> ProcessorMetrics
	23, // 21: ExecutionResult.OutputsEntry.value:type_name -> google.protobuf.Value
	10, // 22: OrcaCore.RegisterProcessor:input_type -> ProcessorRegistration
	3,  // 23: OrcaCore.EmitWindow:input_type -> Window
	14, // 24: OrcaProcessor.ExecuteDagPart:input_type -> ExecutionRequest
	17, // 25: OrcaProcessor.HealthCheck:input_type -> HealthCheckRequest
	16, // 26: OrcaCore.RegisterProcessor:output_type -> Status
	5,  // 27: OrcaCore.EmitWindow:output_type -> WindowEmitStatus
	13, // 28: OrcaProcessor.ExecuteDagPart:output_type -> ExecutionResult
	18, // 29: OrcaProcessor.HealthCheck:output_type -> HealthCheckResponse
